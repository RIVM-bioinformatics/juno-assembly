...
class BrackenMultireport:
    ...
    def enlist_bracken_reports(self):
        ...
        ), f"You need to provide an input dir to find the bracken result files in."
    ...
    def make_multireport(self):
        ...
        top1_per_sample = [
            BrackenResult(file_).find_top_hit() for file_ in self.input_files
        ]
...
if __name__ == "__main__":
    ...
    multireport = BrackenMultireport(
