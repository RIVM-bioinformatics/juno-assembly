...
# ?     The method below makes assumptions about the structure of the ref_file, this can break should the GTDB
# ?     change their ref_name format in the future. This was discussed and agreed to.
base_path = output_multireport.parent
iles_skani_import_base_filename = "skani_summary_iles.csv"  #! Agreed upon filename, hardcoded: do not change without notifying ILES team!
iles_skani_import_filepath = base_path / iles_skani_import_base_filename
...
iles_formatted_skani_results.to_csv(iles_skani_import_filepath, index=False)  #! Agreed upon csv format: do not change without notifying ILES team!
